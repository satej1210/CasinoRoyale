...
set MAINCLASS=ListenerDataPublisher
set JARFILE=saj_listener_pub.jar
set MANIFEST=saj_listener_pub.manifest
...
del /f/s/q classes\ListenerDataPublisher.class classes\DDSEntityManager.class classes\ErrorHandler.class 2>nul
...
echo javac -sourcepath ..\src -cp "saj_listener_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\ListenerDataPublisher.java
javac -sourcepath ..\src -cp "saj_listener_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\ListenerDataPublisher.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
  ECHO *** Java compilation of ..\src\ListenerDataPublisher.java failed
  ECHO:
  GOTO error
)
...
echo pushd classes\ ^& jar %JARFLAGS% %JARFILE% %MANIFEST%  ListenerDataPublisher.class DDSEntityManager.class ErrorHandler.class ^& popd
pushd classes\ & jar %JARFLAGS% %JARFILE% %MANIFEST%  ListenerDataPublisher.class DDSEntityManager.class ErrorHandler.class & popd
