...
del /f/s/q classes\ListenerDataSubscriber.class classes\DDSEntityManager.class classes\ErrorHandler.class 2>nul
...
echo pushd classes\ ^& jar %JARFLAGS% %JARFILE% %MANIFEST%  ListenerDataSubscriber.class DDSEntityManager.class ErrorHandler.class ^& popd
pushd classes\ & jar %JARFLAGS% %JARFILE% %MANIFEST%  ListenerDataSubscriber.class DDSEntityManager.class ErrorHandler.class & popd
