...
set MAINCLASS=OwnershipDataPublisher
set JARFILE=saj_ownership_pub.jar
set MANIFEST=saj_ownership_pub.manifest
...
del /f/s/q classes\OwnershipDataPublisher.class classes\DDSEntityManager.class classes\ErrorHandler.class 2>nul
...
echo javac -sourcepath ..\src -cp "saj_ownership_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\OwnershipDataPublisher.java
javac -sourcepath ..\src -cp "saj_ownership_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\OwnershipDataPublisher.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
  ECHO *** Java compilation of ..\src\OwnershipDataPublisher.java failed
  ECHO:
  GOTO error
)
...
echo pushd classes\ ^& jar %JARFLAGS% %JARFILE% %MANIFEST%  OwnershipDataPublisher.class DDSEntityManager.class ErrorHandler.class ^& popd
pushd classes\ & jar %JARFLAGS% %JARFILE% %MANIFEST%  OwnershipDataPublisher.class DDSEntityManager.class ErrorHandler.class & popd
