...
set JARFILE=saj_pingpong_types.jar
set MANIFEST=saj_pingpong_types.manifest
...
echo "..\..\..\..\..\bin\idlpp" -I "..\..\..\..\..\etc\idl" -l java ..\..\idl\pingpong.idl
"..\..\..\..\..\bin\idlpp" -I "..\..\..\..\..\etc\idl" -l java ..\..\idl\pingpong.idl
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
...
echo javac -cp "classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ .\pingpong\*.java
javac -cp "classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ .\pingpong\*.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
