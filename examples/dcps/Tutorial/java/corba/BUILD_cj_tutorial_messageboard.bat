...
set MAINCLASS=MessageBoard
set JARFILE=cj_tutorial_messageboard.jar
set MANIFEST=cj_tutorial_messageboard.manifest
...
echo javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\MessageBoard.java
javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\MessageBoard.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
...
echo javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\ExtDomainParticipant.java
javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\ExtDomainParticipant.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
...
echo javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\ExtDomainParticipantHelper.java
javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\ExtDomainParticipantHelper.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
...
echo javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\DataReaderListenerImpl.java
javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\DataReaderListenerImpl.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
