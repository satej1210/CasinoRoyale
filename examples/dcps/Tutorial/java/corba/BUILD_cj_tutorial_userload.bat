...
set MAINCLASS=UserLoad
set JARFILE=cj_tutorial_userload.jar
set MANIFEST=cj_tutorial_userload.manifest
...
del /f/s/q classes\chatroom\UserLoad.class classes\chatroom\ErrorHandler.class 2>nul
...
echo javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\UserLoad.java
javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\chatroom\UserLoad.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
  ECHO *** Java compilation of ..\src\chatroom\UserLoad.java failed
  ECHO:
  GOTO error
)
...
echo pushd classes\ ^& jar %JARFLAGS% %JARFILE% %MANIFEST%  chatroom\UserLoad.class chatroom\ErrorHandler.class ^& popd
pushd classes\ & jar %JARFLAGS% %JARFILE% %MANIFEST%  chatroom\UserLoad.class chatroom\ErrorHandler.class & popd
