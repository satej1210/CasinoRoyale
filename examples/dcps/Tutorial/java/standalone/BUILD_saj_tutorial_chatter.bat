...
set MAINCLASS=chatroom.Chatter
set JARFILE=saj_tutorial_chatter.jar
set MANIFEST=saj_tutorial_chatter.manifest
...
echo javac -sourcepath ..\src -cp "saj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\chatroom\Chatter.java
javac -sourcepath ..\src -cp "saj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\chatroom\Chatter.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
