...
set MAINCLASS=chatroom.UserLoad
set JARFILE=saj_tutorial_userload.jar
set MANIFEST=saj_tutorial_userload.manifest
...
echo javac -sourcepath ..\src -cp "saj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\chatroom\UserLoad.java
javac -sourcepath ..\src -cp "saj_tutorial_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\chatroom\UserLoad.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
