...
set JARFILE=saj_querycondition_types.jar
set MANIFEST=saj_querycondition_types.manifest
...
REM
echo Processing ..\..\idl\QueryConditionData.idl....
echo "..\..\..\..\..\bin\idlpp" -I "..\..\..\..\..\etc\idl" -l java ..\..\idl\QueryConditionData.idl
"..\..\..\..\..\bin\idlpp" -I "..\..\..\..\..\etc\idl" -l java ..\..\idl\QueryConditionData.idl
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
  ECHO *** Compilation of ..\..\idl\QueryConditionData.idl failed
  ECHO:
  GOTO error
)
