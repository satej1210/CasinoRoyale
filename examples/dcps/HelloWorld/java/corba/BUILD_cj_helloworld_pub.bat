...
set JARFILE=cj_helloworld_pub.jar
set MANIFEST=cj_helloworld_pub.manifest
...
echo javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_helloworld_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\HelloWorldDataPublisher.java
javac -endorseddirs "%JACORB_HOME%\lib\endorsed" -sourcepath ..\src -cp "cj_helloworld_types.jar;classes\;..\..\..\..\..\jar\dcpscj.jar;" -d classes\ ..\src\HelloWorldDataPublisher.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
