...
set JARFILE=saj_helloworld_sub.jar
set MANIFEST=saj_helloworld_sub.manifest
...
echo javac -sourcepath ..\src -cp "saj_helloworld_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\HelloWorldDataSubscriber.java
javac -sourcepath ..\src -cp "saj_helloworld_types.jar;classes\;..\..\..\..\..\jar\dcpssaj.jar;" -d classes\ ..\src\HelloWorldDataSubscriber.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
