...
public class bjPlayerDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements bjPlayerDataWriter
{
    private long copyCache;
    private bjPlayerTypeSupport typeSupport;

    public bjPlayerDataWriterImpl(CR.bjPlayerTypeSupport ts)
    {
        typeSupport = ts;
