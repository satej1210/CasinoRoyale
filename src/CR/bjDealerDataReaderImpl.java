...
public class bjDealerDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements bjDealerDataReader
{
    private long copyCache;
    private bjDealerTypeSupport typeSupport;

    public bjDealerDataReaderImpl(CR.bjDealerTypeSupport ts)
    {
        typeSupport = ts;
