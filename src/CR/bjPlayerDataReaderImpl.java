...
public class bjPlayerDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements bjPlayerDataReader
{
    private long copyCache;
    private bjPlayerTypeSupport typeSupport;

    public bjPlayerDataReaderImpl(CR.bjPlayerTypeSupport ts)
    {
        typeSupport = ts;
