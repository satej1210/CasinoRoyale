...
public class bjPlayerDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements bjPlayerDataReaderView
{
    private long copyCache;
    private bjPlayerTypeSupport typeSupport;

    public bjPlayerDataReaderViewImpl(CR.bjPlayerTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public int read(
            CR.bjPlayerSeqHolder received_data, 
    ...
    public int read_next_sample(
            CR.bjPlayerHolder received_data, 
