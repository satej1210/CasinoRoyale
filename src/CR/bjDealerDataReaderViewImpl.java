...
public class bjDealerDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements bjDealerDataReaderView
{
    private long copyCache;
    private bjDealerTypeSupport typeSupport;

    public bjDealerDataReaderViewImpl(CR.bjDealerTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public int read(
            CR.bjDealerSeqHolder received_data, 
    ...
    public int read_next_sample(
            CR.bjDealerHolder received_data, 
