...
public class bjPlayerTypeSupport extends org.opensplice.dds.dcps.TypeSupportImpl implements DDS.TypeSupportOperations
{
    private static java.lang.String idl_type_name = "CR::bjPlayer";
    private static java.lang.String idl_key_list = "uuid";

    private long copyCache;

    public bjPlayerTypeSupport()
    {
        super("CR/bjPlayerDataReaderImpl",
            "CR/bjPlayerDataReaderViewImpl",
            "CR/bjPlayerDataWriterImpl",
            "(LCR/bjPlayerTypeSupport;)V",
            "null",
            "null");
        ...
        try {
            success = org.opensplice.dds.dcps.FooTypeSupportImpl.Alloc(
                    ...
                    idl_type_name,
                    idl_key_list,
                    CR.bjPlayerMetaHolder.metaDescriptor);
        ...
        if (success == 0) {
            throw Utilities.createException(
                    ...
                    "Could not allocate bjPlayerTypeSupport." );
        }
    }
