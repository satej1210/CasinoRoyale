...
public class MdsgDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements MdsgDataReaderView
{
    private long copyCache;
    private MdsgTypeSupport typeSupport;

    public MdsgDataReaderViewImpl(HelloWorldData.MdsgTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public int read(
            HelloWorldData.MdsgSeqHolder received_data, 
    ...
    public int read_next_sample(
            HelloWorldData.MdsgHolder received_data, 
