...
public class MdsgDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements MdsgDataReader
{
    private long copyCache;
    private MdsgTypeSupport typeSupport;

    public MdsgDataReaderImpl(HelloWorldData.MdsgTypeSupport ts)
    {
        typeSupport = ts;
